...
let distanceInKilometers: number = 100 * 1.60934; // 160.935
let kilometers = 160.935;
let kilometers1: number = 130;
let miles1: number = 209.2142;
